...
public class MemberControllerTests
{
    ...
    private MemberController CreateMockedMemberController()
    {
        var loggerMock = new Mock<ILogger<MemberController>>();
        return new MemberController(null, loggerMock.Object);
    }

    private static Member GetMemberWithID1()
    {
        return new Member()
        {
            Id = 1,
	...
	private static MemberImage CreateTestImage()
    {
