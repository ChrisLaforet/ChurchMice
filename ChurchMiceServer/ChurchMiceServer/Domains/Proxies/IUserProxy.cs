...
public interface IUserProxy
{
	...
	RoleLevelCode[] GetUserRoles(JsonWebToken token);
	RoleLevelCode GetAssignedRoleLevelCodeFor(UserId userId);
	bool AssignRoleTo(UserId userId, RoleLevelCode roleLevelCode);
}