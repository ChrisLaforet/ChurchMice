...
public class NewUserCommandHandler : ICommandHandler<NewUserCommand, NothingnessResponse>
{
	...
	private readonly ILogger<NewUserCommandHandler> logger;
	
	public NewUserCommandHandler(IUserProxy userProxy, 
									IEmailProxy emailProxy,
									IConfigurationProxy configurationProxy,
									IConfigurationLoader configurationLoader,
									ILogger<NewUserCommandHandler> logger)
	{
	...
	public NothingnessResponse Handle(NewUserCommand command)
	{
	...
	public User CreateUserFor(NewUserCommand command)
	{
		var user = new User();
	...
	private void ValidateUserData(NewUserCommand command)
	{
